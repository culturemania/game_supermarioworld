...
class State:
    ...
    def draw(self, level):
        ...
        label = self.screenfont.render(" x {}".format(level.mario.life), 1, (255, 255, 255))
        screen.blit(label, (32, y))

        screen.blit(self.surfacecoin, (16, y+20))
        label = self.screenfont.render(" x {}".format(level.mario.coins), 1, (255, 255, 255))
        ...
        label = self.screenfont.render(" x {}".format(level.mario.yoshicoins), 1, (255, 255, 255))
        screen.blit(label, (586, y))

        label = self.screenfont.render("Score : {}".format(level.mario.score), 1, (255, 255, 255))
        ...
        if value < 30:
            ...
            label = self.screenfontsmall.render("Time : {}s".format(value), 1, (255, 255, 255))
