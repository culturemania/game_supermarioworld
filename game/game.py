...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Super Mario World IV")
        self.running = True
        self.mariolifes = 3
        self.state = State()
        self.fond = None
    ...
    def save(self):
        ...
        print "Save {}".format(data.coins)
        print "Save {}".format(self.levelidx)
        s = Save()
        s.save(data)
    ...
    def load(self):
        s = Save()
        dataz = s.load()
        self.levelidx = dataz.levelidx
        print self.levelidx

    def start(self):
        print "Stating Super Mario World"

        self.mario = Mario(self.imageMario, 50, 0, 16, 22, 9)
        self.mario.life = 3
        ...
        self.levels.append(DonutPlain00(self, "donutplain01"))
        self.levels.append(DonutPlain00(self, "donutplainvertical"))
        self.levels.append(DonutPlain01(self, "donutplain01"))
        self.levels.append(Castle01(self, "castle01"))
        self.levels.append(DonutPlain00(self, "donutplain00"))
        self.levels.append(DonutPlain03(self, "donutplain03"))
        self.levels.append(DonutPlain02(self, "donutplain02"))
